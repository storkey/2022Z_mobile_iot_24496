...
namespace RealEstateApi.Data
{
    public class ApiDbContext : DbContext
    {
        ...
        {
          optionsBuilder.UseSqlServer(@"Server=tcp:pbosianek-cdv.database.windows.net,1433;Initial Catalog=RealEstateDB;Persist Security Info=False;User ID=pbosianek;Password=6tyYsQGgN4JveBU;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;");
        }
